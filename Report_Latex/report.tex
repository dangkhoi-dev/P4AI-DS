...
\begin{center}
\begin{tabular}{c}
\multicolumn{1}{c}{\textbf{{\Large PROGRAMMING FOR AI : ASSIGNMENTS 1 \& 2 REPORT}}}\\ %Name of the subject
~~\\
\hline
\\
\textbf{{\Large EXPLORATORY DATA ANALYSIS}}\\
\textbf{{\Large \& MACHINE LEARNING PIPELINES}} \\
...
% =======================================================================
% SECTION 1: TABULAR DATA (TITANIC)
% =======================================================================
\section{Tabular Data: Titanic Survival Classification}
\label{sec:tabular}
...
\subsubsection{Data Inspection and Missing Values}
...
\subsubsection{Family Structure Analysis}
...
\subsubsection{Categorical Features vs.\ Survival Target}
...
\subsubsection{Ticket Prefix Analysis}
...
\subsubsection{Key Findings and Preprocessing Recommendations (Tabular EDA)}
...
% --- Tabular ML (Titanic): Preprocessing + Models (subsections continue under Section 1) ---
\input{chapters/a2_tabular}

% =======================================================================
% SECTION 2: TEXT DATA (SMS SPAM)
% =======================================================================
\section{Text Data: SMS Spam Classification}
\label{sec:text}

\subsection{Exploratory Data Analysis}
\input{chapters/1.2}

% --- Text ML (SMS Spam): Preprocessing + Models (subsections continue under Section 2) ---
\input{chapters/a2_text}

% =======================================================================
% SECTION 3: IMAGE DATA (CIFAR-10)
% =======================================================================
\section{Image Data: CIFAR-10 Classification}
\label{sec:image}
...
\subsubsection{Statistical Analysis of Pixels}
...
\subsubsection{Per-Class Visual Analysis}
...
\subsubsection{Key Findings and Preprocessing Recommendations (Image EDA)}
...
% --- Image ML (CIFAR-10): Preprocessing + Models (subsections continue under Section 3) ---
\input{chapters/a2_image}

% =======================================================================
% SECTION 4: MULTIMODAL DATA (FLICKR8K) -- EDA ONLY, NO ML
% =======================================================================
\section{Multimodal Data: Flickr8k}
\label{sec:multi}
...
\begin{itemize}
    ...
    \item \textbf{Presentation Video (YouTube):} \url{https://youtu.be/Ikld5pqy6e8}
\end{itemize}
...
\addcontentsline{toc}{section}{Attribution \& Data Sources}
